...
namespace Naos.Reactor.Domain.Test
{
    ...
    public static partial class DetailsReactionContextTest
    {
        ...
        private static readonly ValidModelTestScenarios<DetailsReactionContext> ValidModelTestScenarios = new ValidModelTestScenarios<DetailsReactionContext>()
            .AddScenario(() =>
                new ValidModelTestScenario<DetailsReactionContext>
                {
                    Name = "a dummy DetailsReactionContext should be valid",
                    SystemUnderTest = A.Dummy<DetailsReactionContext>(),
                });
