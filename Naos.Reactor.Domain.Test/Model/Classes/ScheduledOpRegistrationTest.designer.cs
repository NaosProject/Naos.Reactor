...
namespace Naos.Reactor.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<ScheduledOpRegistration> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<ScheduledOpRegistration>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<ScheduledOpRegistration>
                {
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<ScheduledOpRegistration> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<ScheduledOpRegistration>()
            .AddScenario(() =>
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<ScheduledOpRegistration>
                {
                    Name = "constructor should throw ArgumentOutOfRangeException when parameter 'scheduledOpAlreadyRunningStrategy' is ScheduledOpAlreadyRunningStrategy.Unknown",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<ScheduledOpRegistration>();
                    ...
                    ExpectedExceptionMessageContains = new[] { "scheduledOpAlreadyRunningStrategy", "Unknown", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<ScheduledOpRegistration>
                {
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<ScheduledOpRegistration> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<ScheduledOpRegistration>()
            .AddScenario(() =>
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ScheduledOpRegistration>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<ScheduledOpRegistration>().ThatIs(_ => !systemUnderTest.Id.IsEqualTo(_.Id));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ScheduledOpRegistration>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<ScheduledOpRegistration>().ThatIs(_ => !systemUnderTest.OperationToExecute.IsEqualTo(_.OperationToExecute));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ScheduledOpRegistration>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<ScheduledOpRegistration>().ThatIs(_ => !systemUnderTest.Schedule.IsEqualTo(_.Schedule));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ScheduledOpRegistration>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<ScheduledOpRegistration>().ThatIs(_ => !systemUnderTest.Tags.IsEqualTo(_.Tags));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ScheduledOpRegistration>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<ScheduledOpRegistration>().ThatIs(_ => !systemUnderTest.StreamRepresentation.IsEqualTo(_.StreamRepresentation));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ScheduledOpRegistration>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<ScheduledOpRegistration>().ThatIs(_ => !systemUnderTest.ScheduledOpAlreadyRunningStrategy.IsEqualTo(_.ScheduledOpAlreadyRunningStrategy));

                        var result = new SystemUnderTestDeepCloneWithValue<ScheduledOpRegistration>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.ScheduledOpAlreadyRunningStrategy,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ScheduledOpRegistration>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<ScheduledOpRegistration>().ThatIs(_ => !systemUnderTest.Details.IsEqualTo(_.Details));
        ...
        private static readonly EquatableTestScenarios<ScheduledOpRegistration> EquatableTestScenarios = new EquatableTestScenarios<ScheduledOpRegistration>()
            .AddScenario(() =>
                new EquatableTestScenario<ScheduledOpRegistration>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new ScheduledOpRegistration[]
                    {
        ...
        private static readonly ValidModelTestScenarios<ScheduledOpRegistration> ValidModelTestScenarios = new ValidModelTestScenarios<ScheduledOpRegistration>()
            .AddScenario(() =>
                new ValidModelTestScenario<ScheduledOpRegistration>
                {
                    Name = "a dummy ScheduledOpRegistration should be valid",
                    SystemUnderTest = A.Dummy<ScheduledOpRegistration>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void ScheduledOpRegistration___Should_implement_IModel_of_ScheduledOpRegistration___When_reflecting()
            {
                // Arrange
                var type = typeof(ScheduledOpRegistration);

                var expectedModelMethods = typeof(IModel<ScheduledOpRegistration>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<ScheduledOpRegistration>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ScheduledOpRegistration___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ScheduledOpRegistration);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (ScheduledOpRegistration)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (ScheduledOpRegistration)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(ScheduledOpRegistration).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<ScheduledOpRegistration>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                ScheduledOpRegistration systemUnderTest1 = null;
                ScheduledOpRegistration systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    ScheduledOpRegistration systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ScheduledOpRegistration___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ScheduledOpRegistration___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ScheduledOpRegistration___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ScheduledOpRegistration___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ScheduledOpRegistration___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
