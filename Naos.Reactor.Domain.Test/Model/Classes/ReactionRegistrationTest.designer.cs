...
namespace Naos.Reactor.Domain.Test
{
    ...
    public static partial class ReactionRegistrationTest
    {
        ...
        private static readonly ValidModelTestScenarios<ReactionRegistration> ValidModelTestScenarios = new ValidModelTestScenarios<ReactionRegistration>()
            .AddScenario(() =>
                new ValidModelTestScenario<ReactionRegistration>
                {
                    Name = "a dummy ReactionRegistration should be valid",
                    SystemUnderTest = A.Dummy<ReactionRegistration>(),
                });
