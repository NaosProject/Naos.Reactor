...
namespace Naos.Reactor.Domain.Test
{
    ...
    public static partial class EventToPutWithIdTIdTest
    {
        ...
        private static readonly ValidModelTestScenarios<EventToPutWithId<Version>> ValidModelTestScenarios = new ValidModelTestScenarios<EventToPutWithId<Version>>()
            .AddScenario(() =>
                new ValidModelTestScenario<EventToPutWithId<Version>>
                {
                    Name = "a dummy EventToPutWithId<Version> should be valid",
                    SystemUnderTest = A.Dummy<EventToPutWithId<Version>>(),
                });
