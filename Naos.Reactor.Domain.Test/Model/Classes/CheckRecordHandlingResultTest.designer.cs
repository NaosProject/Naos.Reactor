...
namespace Naos.Reactor.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<CheckRecordHandlingResult> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<CheckRecordHandlingResult>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<CheckRecordHandlingResult>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<CheckRecordHandlingResult>();

                        var result = new SystemUnderTestExpectedStringRepresentation<CheckRecordHandlingResult>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Reactor.Domain.CheckRecordHandlingResult: StreamRepresentation = {systemUnderTest.StreamRepresentation?.ToString() ?? "<null>"}, InternalRecordIdToHandlingStatusMap = {systemUnderTest.InternalRecordIdToHandlingStatusMap?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<CheckRecordHandlingResult> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<CheckRecordHandlingResult>()
            .AddScenario(() =>
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<CheckRecordHandlingResult> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<CheckRecordHandlingResult>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<CheckRecordHandlingResult>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<CheckRecordHandlingResult>
                        {
                            SystemUnderTest = new CheckRecordHandlingResult(
                                                      referenceObject.StreamRepresentation,
                                                      referenceObject.InternalRecordIdToHandlingStatusMap),
        ...
        private static readonly DeepCloneWithTestScenarios<CheckRecordHandlingResult> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<CheckRecordHandlingResult>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CheckRecordHandlingResult>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CheckRecordHandlingResult>().ThatIs(_ => !systemUnderTest.StreamRepresentation.IsEqualTo(_.StreamRepresentation));

                        var result = new SystemUnderTestDeepCloneWithValue<CheckRecordHandlingResult>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CheckRecordHandlingResult>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CheckRecordHandlingResult>().ThatIs(_ => !systemUnderTest.InternalRecordIdToHandlingStatusMap.IsEqualTo(_.InternalRecordIdToHandlingStatusMap));
        ...
        private static readonly CheckRecordHandlingResult ReferenceObjectForEquatableTestScenarios = A.Dummy<CheckRecordHandlingResult>();

        private static readonly EquatableTestScenarios<CheckRecordHandlingResult> EquatableTestScenarios = new EquatableTestScenarios<CheckRecordHandlingResult>()
            .AddScenario(() =>
                new EquatableTestScenario<CheckRecordHandlingResult>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new CheckRecordHandlingResult[]
                    {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new CheckRecordHandlingResult[]
                    {
                        new CheckRecordHandlingResult(
                                A.Dummy<CheckRecordHandlingResult>().Whose(_ => !_.StreamRepresentation.IsEqualTo(ReferenceObjectForEquatableTestScenarios.StreamRepresentation)).StreamRepresentation,
                                ReferenceObjectForEquatableTestScenarios.InternalRecordIdToHandlingStatusMap),
                        new CheckRecordHandlingResult(
                                ReferenceObjectForEquatableTestScenarios.StreamRepresentation,
                                A.Dummy<CheckRecordHandlingResult>().Whose(_ => !_.InternalRecordIdToHandlingStatusMap.IsEqualTo(ReferenceObjectForEquatableTestScenarios.InternalRecordIdToHandlingStatusMap)).InternalRecordIdToHandlingStatusMap),
                    },
        ...
        private static readonly ValidModelTestScenarios<CheckRecordHandlingResult> ValidModelTestScenarios = new ValidModelTestScenarios<CheckRecordHandlingResult>()
            .AddScenario(() =>
                new ValidModelTestScenario<CheckRecordHandlingResult>
                {
                    Name = "a dummy CheckRecordHandlingResult should be valid",
                    SystemUnderTest = A.Dummy<CheckRecordHandlingResult>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void CheckRecordHandlingResult___Should_implement_IModel_of_CheckRecordHandlingResult___When_reflecting()
            {
                // Arrange
                var type = typeof(CheckRecordHandlingResult);

                var expectedModelMethods = typeof(IModel<CheckRecordHandlingResult>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<CheckRecordHandlingResult>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void CheckRecordHandlingResult___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(CheckRecordHandlingResult);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (CheckRecordHandlingResult)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "StreamRepresentation", "InternalRecordIdToHandlingStatusMap" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (CheckRecordHandlingResult)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(CheckRecordHandlingResult).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<CheckRecordHandlingResult>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                CheckRecordHandlingResult systemUnderTest1 = null;
                CheckRecordHandlingResult systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    CheckRecordHandlingResult systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CheckRecordHandlingResult___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CheckRecordHandlingResult___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CheckRecordHandlingResult___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CheckRecordHandlingResult___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CheckRecordHandlingResult___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
