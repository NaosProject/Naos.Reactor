...
namespace Naos.Reactor.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<ReactionEvent> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<ReactionEvent>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<ReactionEvent>
                {
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<ReactionEvent> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<ReactionEvent>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<ReactionEvent>
                {
                    ...
                    ConstructionFunc = () =>
                    {
                        ...
                        var result = new ReactionEvent(
                                             null,
                                             referenceObject.RegisteredReactionId,
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<ReactionEvent>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'registeredReactionId' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<ReactionEvent>();
                    ...
                    ExpectedExceptionType = typeof(ArgumentNullException),
                    ExpectedExceptionMessageContains = new[] { "registeredReactionId", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<ReactionEvent>
                {
                    Name = "constructor should throw ArgumentException when parameter 'registeredReactionId' is white space scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<ReactionEvent>();
                    ...
                    ExpectedExceptionType = typeof(ArgumentException),
                    ExpectedExceptionMessageContains = new[] { "registeredReactionId", "white space", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<ReactionEvent>
                {
                    ...
                    ExpectedExceptionType = typeof(ArgumentNullException),
                    ExpectedExceptionMessageContains = new[] { "streamRepresentationToInternalRecordIdsMap", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<ReactionEvent>
                {
                    Name = "constructor should throw ArgumentException when parameter 'streamRepresentationToInternalRecordIdsMap' is an empty dictionary scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<ReactionEvent>();
                    ...
                    ExpectedExceptionType = typeof(ArgumentException),
                    ExpectedExceptionMessageContains = new[] { "streamRepresentationToInternalRecordIdsMap", "is an empty dictionary", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<ReactionEvent>
                {
                    Name = "constructor should throw ArgumentException when parameter 'streamRepresentationToInternalRecordIdsMap' contains a key-value pair with a null value scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<ReactionEvent>();

                        var dictionaryWithNullValue = referenceObject.StreamRepresentationToInternalRecordIdsMap.ToDictionary(_ => _.Key, _ => _.Value);
                    ...
                    ExpectedExceptionType = typeof(ArgumentException),
                    ExpectedExceptionMessageContains = new[] { "streamRepresentationToInternalRecordIdsMap", "contains at least one key-value pair with a null value", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<ReactionEvent>
                {
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<ReactionEvent> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<ReactionEvent>()
            .AddScenario(() =>
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<ReactionEvent>
                {
                    Name = "RegisteredReactionId should return same 'registeredReactionId' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<ReactionEvent>();
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<ReactionEvent>
                        {
                            SystemUnderTest = new ReactionEvent(
                                                      ...
                                                      referenceObject.TimestampUtc,
                                                      referenceObject.Tags),
                            ExpectedPropertyValue = referenceObject.RegisteredReactionId,
                        };

                        return result;
                    },
                    PropertyName = "RegisteredReactionId",
                })
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<ReactionEvent>
                {
                    Name = "StreamRepresentationToInternalRecordIdsMap should return same 'streamRepresentationToInternalRecordIdsMap' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<ReactionEvent>();
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<ReactionEvent>
                        {
                            SystemUnderTest = new ReactionEvent(
                                                      ...
                                                      referenceObject.TimestampUtc,
                                                      referenceObject.Tags),
                            ExpectedPropertyValue = referenceObject.StreamRepresentationToInternalRecordIdsMap,
                        };

                        return result;
                    },
                    PropertyName = "StreamRepresentationToInternalRecordIdsMap",
                })
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<ReactionEvent>
                {
        ...
        private static readonly DeepCloneWithTestScenarios<ReactionEvent> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<ReactionEvent>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ReactionEvent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<ReactionEvent>().ThatIs(_ => !systemUnderTest.TimestampUtc.IsEqualTo(_.TimestampUtc));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ReactionEvent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<ReactionEvent>().ThatIs(_ => !systemUnderTest.Id.IsEqualTo(_.Id));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ReactionEvent>
                {
                    Name = "DeepCloneWithRegisteredReactionId should deep clone object and replace RegisteredReactionId with the provided registeredReactionId",
                    WithPropertyName = "RegisteredReactionId",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<ReactionEvent>();

                        var referenceObject = A.Dummy<ReactionEvent>().ThatIs(_ => !systemUnderTest.RegisteredReactionId.IsEqualTo(_.RegisteredReactionId));

                        var result = new SystemUnderTestDeepCloneWithValue<ReactionEvent>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.RegisteredReactionId,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ReactionEvent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<ReactionEvent>().ThatIs(_ => !systemUnderTest.StreamRepresentationToInternalRecordIdsMap.IsEqualTo(_.StreamRepresentationToInternalRecordIdsMap));

                        var result = new SystemUnderTestDeepCloneWithValue<ReactionEvent>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.StreamRepresentationToInternalRecordIdsMap,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ReactionEvent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<ReactionEvent>().ThatIs(_ => !systemUnderTest.Tags.IsEqualTo(_.Tags));
        ...
        private static readonly ReactionEvent ReferenceObjectForEquatableTestScenarios = A.Dummy<ReactionEvent>();

        private static readonly EquatableTestScenarios<ReactionEvent> EquatableTestScenarios = new EquatableTestScenarios<ReactionEvent>()
            .AddScenario(() =>
                new EquatableTestScenario<ReactionEvent>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new ReactionEvent[]
                    {
                        new ReactionEvent(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                ReferenceObjectForEquatableTestScenarios.RegisteredReactionId,
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new ReactionEvent[]
                    {
                        new ReactionEvent(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                ReferenceObjectForEquatableTestScenarios.RegisteredReactionId,
                        ...
                        new ReactionEvent(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                A.Dummy<ReactionEvent>().Whose(_ => !_.RegisteredReactionId.IsEqualTo(ReferenceObjectForEquatableTestScenarios.RegisteredReactionId)).RegisteredReactionId,
                                ReferenceObjectForEquatableTestScenarios.StreamRepresentationToInternalRecordIdsMap,
                                ReferenceObjectForEquatableTestScenarios.TimestampUtc,
                                ReferenceObjectForEquatableTestScenarios.Tags),
                        new ReactionEvent(
                    ...
                    ObjectsThatAreNotOfTheSameTypeAsReferenceObject = new object[]
                    {
                        ...
                        A.Dummy<int?>(),
                        A.Dummy<Guid>(),
                        A.Dummy<ScheduledExecutionEvent>(),
                    },
                });
        ...
        public static class Structural
        {
            ...
            public static void ReactionEvent___Should_implement_IModel_of_ReactionEvent___When_reflecting()
            {
                // Arrange
                var type = typeof(ReactionEvent);

                var expectedModelMethods = typeof(IModel<ReactionEvent>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<ReactionEvent>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ReactionEvent___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ReactionEvent);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (ReactionEvent)systemUnderTest.Clone();
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                else if (!actual.StreamRepresentationToInternalRecordIdsMap.GetType().IsValueType)
                {
                    // When the declared type is a reference type, we still have to check the runtime type.
                    // The object could be a boxed value type, which will fail this asseration because
                    // a deep clone of a value type object is the same object.
                    actual.StreamRepresentationToInternalRecordIdsMap.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.StreamRepresentationToInternalRecordIdsMap);
                }
            ...
            {
                var propertyNames = new string[] { "TimestampUtc", "Id", "RegisteredReactionId", "StreamRepresentationToInternalRecordIdsMap", "Tags" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (ReactionEvent)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(ReactionEvent).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<ReactionEvent>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                ReactionEvent systemUnderTest1 = null;
                ReactionEvent systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    ReactionEvent systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReactionEvent___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReactionEvent___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReactionEvent___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReactionEvent___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReactionEvent___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
