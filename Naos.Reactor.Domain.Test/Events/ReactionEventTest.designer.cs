...
namespace Naos.Reactor.Domain.Test
{
    ...
    public static partial class ReactionEventTest
    {
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ReactionEvent>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<ReactionEvent>().ThatIs(_ => !systemUnderTest.ReactionRegistrationId.IsEqualTo(_.ReactionRegistrationId));
        ...
        private static readonly ValidModelTestScenarios<ReactionEvent> ValidModelTestScenarios = new ValidModelTestScenarios<ReactionEvent>()
            .AddScenario(() =>
                new ValidModelTestScenario<ReactionEvent>
                {
                    Name = "a dummy ReactionEvent should be valid",
                    SystemUnderTest = A.Dummy<ReactionEvent>(),
                });
