...
namespace Naos.Reactor.Domain.Test
{
    ...
    public static partial class WriteEventOnMatchingHandlingStatusOpTIdTest
    {
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<WriteEventOnMatchingHandlingStatusOp<Version>>
                {
                    ...
                    ConstructionFunc = () =>
                    {
                        ...
                        var result = new WriteEventOnMatchingHandlingStatusOp<Version>(
                                             referenceObject.CheckRecordHandlingOps,
                                             new List<EventToPutWithIdOnHandlingStatusMatch<Version>>(),
                                             referenceObject.WaitTimeBeforeRetry);
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<WriteEventOnMatchingHandlingStatusOp<Version>>
                {
                    ...
                    ConstructionFunc = () =>
                    {
                        ...
                        var result = new WriteEventOnMatchingHandlingStatusOp<Version>(
                                             referenceObject.CheckRecordHandlingOps,
                                             new EventToPutWithIdOnHandlingStatusMatch<Version>[0].Concat(referenceObject.EventToPutOnMatchChainOfResponsibility).Concat(new EventToPutWithIdOnHandlingStatusMatch<Version>[] { null }).Concat(referenceObject.EventToPutOnMatchChainOfResponsibility).ToList(),
                                             referenceObject.WaitTimeBeforeRetry);
        ...
        private static readonly ValidModelTestScenarios<WriteEventOnMatchingHandlingStatusOp<Version>> ValidModelTestScenarios = new ValidModelTestScenarios<WriteEventOnMatchingHandlingStatusOp<Version>>()
            .AddScenario(() =>
                new ValidModelTestScenario<WriteEventOnMatchingHandlingStatusOp<Version>>
                {
                    Name = "a dummy WriteEventOnMatchingHandlingStatusOp<Version> should be valid",
                    SystemUnderTest = A.Dummy<WriteEventOnMatchingHandlingStatusOp<Version>>(),
                });
