...
namespace Naos.Reactor.Domain.Test
{
    ...
    public static partial class ExecuteOpOnScheduleOpTest
    {
                ...
                new StringRepresentationTestScenario<ExecuteOpOnScheduleOp>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<ExecuteOpOnScheduleOp>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"Naos.Reactor.Domain.ExecuteOpOnScheduleOp: Operation = {systemUnderTest.Operation?.ToString() ?? "<null>"}, Schedule = {systemUnderTest.Schedule?.ToString() ?? "<null>"}."),
                        };
        ...
        public static class Cloning
        {
            ...
            {
                var propertyNames = new string[] { "Operation", "Schedule" };
