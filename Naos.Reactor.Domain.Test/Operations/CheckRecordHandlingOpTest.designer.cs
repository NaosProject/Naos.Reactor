...
namespace Naos.Reactor.Domain.Test
{
    ...
    public static partial class CheckRecordHandlingOpTest
    {
        ...
        private static readonly ValidModelTestScenarios<CheckRecordHandlingOp> ValidModelTestScenarios = new ValidModelTestScenarios<CheckRecordHandlingOp>()
            .AddScenario(() =>
                new ValidModelTestScenario<CheckRecordHandlingOp>
                {
                    Name = "a dummy CheckRecordHandlingOp should be valid",
                    SystemUnderTest = A.Dummy<CheckRecordHandlingOp>(),
                });
