...
namespace Naos.Reactor.Domain.Test
{
    ...
    public static partial class RunReactorOpTest
    {
        ...
        private static readonly ValidModelTestScenarios<RunReactorOp> ValidModelTestScenarios = new ValidModelTestScenarios<RunReactorOp>()
            .AddScenario(() =>
                new ValidModelTestScenario<RunReactorOp>
                {
                    Name = "a dummy RunReactorOp should be valid",
                    SystemUnderTest = A.Dummy<RunReactorOp>(),
                });
