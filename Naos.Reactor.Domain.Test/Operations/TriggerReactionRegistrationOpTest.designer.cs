...
namespace Naos.Reactor.Domain.Test
{
    ...
    public static partial class TriggerReactionRegistrationOpTest
    {
        ...
        private static readonly ValidModelTestScenarios<TriggerReactionRegistrationOp> ValidModelTestScenarios = new ValidModelTestScenarios<TriggerReactionRegistrationOp>()
            .AddScenario(() =>
                new ValidModelTestScenario<TriggerReactionRegistrationOp>
                {
                    Name = "a dummy TriggerReactionRegistrationOp should be valid",
                    SystemUnderTest = A.Dummy<TriggerReactionRegistrationOp>(),
                });
