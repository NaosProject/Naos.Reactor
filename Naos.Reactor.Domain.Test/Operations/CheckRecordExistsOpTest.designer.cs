...
namespace Naos.Reactor.Domain.Test
{
    ...
    public static partial class CheckRecordExistsOpTest
    {
        ...
        private static readonly ValidModelTestScenarios<CheckRecordExistsOp> ValidModelTestScenarios = new ValidModelTestScenarios<CheckRecordExistsOp>()
            .AddScenario(() =>
                new ValidModelTestScenario<CheckRecordExistsOp>
                {
                    Name = "a dummy CheckRecordExistsOp should be valid",
                    SystemUnderTest = A.Dummy<CheckRecordExistsOp>(),
                });
