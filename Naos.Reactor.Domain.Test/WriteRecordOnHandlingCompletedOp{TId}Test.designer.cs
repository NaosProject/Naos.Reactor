    ...
    public static partial class WriteRecordOnHandlingCompletedOpTIdTest
    {
                ...
                new StringRepresentationTestScenario<WriteRecordOnHandlingCompletedOp<Version>>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<WriteRecordOnHandlingCompletedOp<Version>>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"Naos.Reactor.Domain.WriteRecordOnHandlingCompletedOp<Version>: CheckRecordHandlingOps = {systemUnderTest.CheckRecordHandlingOps?.ToString() ?? "<null>"}, StatusToRecordToWriteMap = {systemUnderTest.StatusToRecordToWriteMap?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<WriteRecordOnHandlingCompletedOp<Version>> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<WriteRecordOnHandlingCompletedOp<Version>>()
                ...
                new ConstructorArgumentValidationTestScenario<WriteRecordOnHandlingCompletedOp<Version>>
                {
                    ...
                    ConstructionFunc = () =>
                    {
                        ...
                        var result = new WriteRecordOnHandlingCompletedOp<Version>(
                                             null,
                                             referenceObject.StatusToRecordToWriteMap);
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<WriteRecordOnHandlingCompletedOp<Version>>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'statusToRecordToWriteMap' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<WriteRecordOnHandlingCompletedOp<Version>>();
                    ...
                    ExpectedExceptionType = typeof(ArgumentNullException),
                    ExpectedExceptionMessageContains = new[] { "statusToRecordToWriteMap", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<WriteRecordOnHandlingCompletedOp<Version>>
                {
                    Name = "constructor should throw ArgumentException when parameter 'statusToRecordToWriteMap' is an empty dictionary scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<WriteRecordOnHandlingCompletedOp<Version>>();
                        ...
                        var result = new WriteRecordOnHandlingCompletedOp<Version>(
                                             referenceObject.CheckRecordHandlingOps,
                                             new Dictionary<CompositeHandlingStatus, EventToPutWithId<Version>>());

                        return result;
                    },
                    ExpectedExceptionType = typeof(ArgumentException),
                    ExpectedExceptionMessageContains = new[] { "statusToRecordToWriteMap", "is an empty dictionary", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<WriteRecordOnHandlingCompletedOp<Version>>
                {
                    Name = "constructor should throw ArgumentException when parameter 'statusToRecordToWriteMap' contains a key-value pair with a null value scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<WriteRecordOnHandlingCompletedOp<Version>>();

                        var dictionaryWithNullValue = referenceObject.StatusToRecordToWriteMap.ToDictionary(_ => _.Key, _ => _.Value);
                    ...
                    ExpectedExceptionType = typeof(ArgumentException),
                    ExpectedExceptionMessageContains = new[] { "statusToRecordToWriteMap", "contains at least one key-value pair with a null value", },
                });
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<WriteRecordOnHandlingCompletedOp<Version>> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<WriteRecordOnHandlingCompletedOp<Version>>()
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<WriteRecordOnHandlingCompletedOp<Version>>
                {
                    Name = "StatusToRecordToWriteMap should return same 'statusToRecordToWriteMap' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<WriteRecordOnHandlingCompletedOp<Version>>();
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<WriteRecordOnHandlingCompletedOp<Version>>
                        {
                            SystemUnderTest = new WriteRecordOnHandlingCompletedOp<Version>(
                                                      referenceObject.CheckRecordHandlingOps,
                                                      referenceObject.StatusToRecordToWriteMap),
                            ExpectedPropertyValue = referenceObject.StatusToRecordToWriteMap,
                        };

                        return result;
                    },
                    PropertyName = "StatusToRecordToWriteMap",
                });
        ...
        private static readonly DeepCloneWithTestScenarios<WriteRecordOnHandlingCompletedOp<Version>> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<WriteRecordOnHandlingCompletedOp<Version>>()
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<WriteRecordOnHandlingCompletedOp<Version>>
                {
                    Name = "DeepCloneWithStatusToRecordToWriteMap should deep clone object and replace StatusToRecordToWriteMap with the provided statusToRecordToWriteMap",
                    WithPropertyName = "StatusToRecordToWriteMap",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<WriteRecordOnHandlingCompletedOp<Version>>();

                        var referenceObject = A.Dummy<WriteRecordOnHandlingCompletedOp<Version>>().ThatIs(_ => !systemUnderTest.StatusToRecordToWriteMap.IsEqualTo(_.StatusToRecordToWriteMap));

                        var result = new SystemUnderTestDeepCloneWithValue<WriteRecordOnHandlingCompletedOp<Version>>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.StatusToRecordToWriteMap,
                        };
                ...
                new EquatableTestScenario<WriteRecordOnHandlingCompletedOp<Version>>
                {
                    ...
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new WriteRecordOnHandlingCompletedOp<Version>[]
                    {
                        new WriteRecordOnHandlingCompletedOp<Version>(
                                ...
                                ReferenceObjectForEquatableTestScenarios.StatusToRecordToWriteMap),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new WriteRecordOnHandlingCompletedOp<Version>[]
                    {
                        ...
                        new WriteRecordOnHandlingCompletedOp<Version>(
                                ReferenceObjectForEquatableTestScenarios.CheckRecordHandlingOps,
                                A.Dummy<WriteRecordOnHandlingCompletedOp<Version>>().Whose(_ => !_.StatusToRecordToWriteMap.IsEqualTo(ReferenceObjectForEquatableTestScenarios.StatusToRecordToWriteMap)).StatusToRecordToWriteMap),
                    },
        ...
        public static class Cloning
        {
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                if (systemUnderTest.StatusToRecordToWriteMap == null)
                {
                    actual.StatusToRecordToWriteMap.AsTest().Must().BeNull();
                }
                else if (!actual.StatusToRecordToWriteMap.GetType().IsValueType)
                {
                    // When the declared type is a reference type, we still have to check the runtime type.
                    // The object could be a boxed value type, which will fail this asseration because
                    // a deep clone of a value type object is the same object.
                    actual.StatusToRecordToWriteMap.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.StatusToRecordToWriteMap);
                }
            }
            ...
            {
                var propertyNames = new string[] { "CheckRecordHandlingOps", "StatusToRecordToWriteMap" };
