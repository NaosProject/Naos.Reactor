    ...
    public partial class ReactionEvent : IModel<ReactionEvent>
    {
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.StreamRepresentationToInternalRecordIdsMap, options, propertyPathTracker, nameof(this.StreamRepresentationToInternalRecordIdsMap));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
