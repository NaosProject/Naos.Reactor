    ...
    public partial class ScheduledExecuteOpRequestedEvent : IModel<ScheduledExecuteOpRequestedEvent>
    {
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.TargetExecutionUtc, options, propertyPathTracker, nameof(this.TargetExecutionUtc));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
