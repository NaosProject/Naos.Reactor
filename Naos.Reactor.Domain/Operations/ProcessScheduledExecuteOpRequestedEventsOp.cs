// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ProcessScheduledExecuteOpRequestedEventsOp.cs" company="Naos Project">
...
namespace Naos.Reactor.Domain
{
    ...
    /// <summary>
    /// Evaluates all <see cref="ScheduledExecuteOpRequestedEvent{TOperation}" />'s.
    /// </summary>
    public partial class ProcessScheduledExecuteOpRequestedEventsOp : VoidOperationBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProcessScheduledExecuteOpRequestedEventsOp"/> class.
        /// </summary>
        ...
        public ProcessScheduledExecuteOpRequestedEventsOp(
