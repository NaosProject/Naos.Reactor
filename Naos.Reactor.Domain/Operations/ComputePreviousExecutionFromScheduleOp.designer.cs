    ...
    public partial class ComputePreviousExecutionFromScheduleOp : IModel<ComputePreviousExecutionFromScheduleOp>
    {
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.ReferenceTimestampUtc, options, propertyPathTracker, nameof(this.ReferenceTimestampUtc));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
