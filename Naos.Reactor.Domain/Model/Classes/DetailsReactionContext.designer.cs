...
namespace Naos.Reactor.Domain
{
    ...
    [Serializable]
    public partial class DetailsReactionContext : IModel<DetailsReactionContext>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="DetailsReactionContext"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(DetailsReactionContext left, DetailsReactionContext right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="DetailsReactionContext"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(DetailsReactionContext left, DetailsReactionContext right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(DetailsReactionContext other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as DetailsReactionContext);
        ...
        /// <inheritdoc />
        public DetailsReactionContext DeepClone()
        {
        ...
        /// <returns>New <see cref="DetailsReactionContext" /> using the specified <paramref name="details" /> for <see cref="Details" /> and a deep clone of every other property.</returns>
        ...
        public DetailsReactionContext DeepCloneWithDetails(string details)
        {
            var result = new DetailsReactionContext(
                                 details);
        ...
        {
            var result = Invariant($"Naos.Reactor.Domain.DetailsReactionContext: Details = {this.Details?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}.");
